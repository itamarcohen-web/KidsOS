...
int main(int argc, char *argv[])
{
    ...
    // KIDSOS_DEV_QML_DIR lets developers run against the source tree
    // without installing anything (see docs/BUILD.md).
    if (qEnvironmentVariableIsSet("KIDSOS_DEV_QML_DIR"))
        engine.addImportPath(qEnvironmentVariable("KIDSOS_DEV_QML_DIR"));
    else
